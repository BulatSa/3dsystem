		...
		<div class="row">
			<div class="grid-2 grid-4_l grid-6_s">
				<a href="/catalog.php" class="printer-cart">
					<img src="img/cats/cat-1.jpg" alt="">
					<span class="printer-cart__title">3D принтеры</span>
				</a>
			...
			<div class="grid-2 grid-4_l grid-6_s">
				<a href="/catalog.php" class="printer-cart">
					<img src="img/cats/cat-2.jpg" alt="">
					<span class="printer-cart__title">3D сканеры</span>
				</a>
				<ul class="cat-root-list">
					<li><a href="/catalog.php">Лучшие предложения</a></li>
					<li><a href="/catalog.php">Персональные</a></li>
			...
			<div class="grid-2 grid-4_l grid-6_s">
				<a href="/catalog.php" class="printer-cart">
					<img src="img/cats/cat-3.jpg" alt="">
					<span class="printer-cart__title">Аксессуары</span>
				</a>
				<ul class="cat-root-list">
			...
			<div class="grid-2 grid-4_l grid-6_s">
				<a href="/catalog.php" class="printer-cart">
					<img src="img/cats/cat-4.jpg" alt="">
					<span class="printer-cart__title">Гаджеты</span>
				</a>
				<ul class="cat-root-list">
			...
			<div class="grid-2 grid-4_l grid-6_s">
				<a href="/catalog.php" class="printer-cart">
					<img src="img/cats/cat-5.jpg" alt="">
					<span class="printer-cart__title">Расходные материалы</span>
				</a>
				<ul class="cat-root-list">
					<li><a href="/catalog.php">Для 3D ручек</a></li>
					<li><a href="/catalog.php">CyberaFiber</a></li>
			...
			<div class="grid-2 grid-4_l grid-6_s">
				<a href="/catalog.php" class="printer-cart">
					<img src="img/cats/cat-6.jpg" alt="">
					<span class="printer-cart__title">Станки ЧПУ</span>
				</a>
				<ul class="cat-root-list">
			...
			<div class="grid-2 grid-4_l grid-6_s">
				<a href="/catalog.php" class="printer-cart">
					<img src="img/cats/cat-7.jpg" alt="">
					<span class="printer-cart__title">Робототехника</span>
				</a>
				<ul class="cat-root-list">
			...
			<div class="grid-2 grid-4_l grid-6_s">
				<a href="/catalog.php" class="printer-cart">
					<img src="img/cats/cat-8.jpg" alt="">
					<span class="printer-cart__title">Литьевое оборудование</span>
				</a>
				<ul class="cat-root-list">
